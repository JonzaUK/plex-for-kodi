...
<focusedlayout width="575" condition="String.IsEqual(Window.Property(hub.display.{{ hub_id }}),ar16x9)">
    <control type="group">
        ...
        <posy>{{ vscale(72) }}</posy>
        <control type="group">
            <animation effect="zoom" start="100" end="105" time="150" center="271,{{ vscale(149.5) }}">Focus</animation>
            <animation effect="zoom" start="105" end="100" time="0" center="271,{{ vscale(149.5) }}">UnFocus</animation>
            <posx>0</posx>
            <posy>0</posy>
            <control type="image">
            ...
            <control type="group">
                ...
                <control type="image">
                    ...
                    <width>532</width>
                    <height>{{ vscale(299) }}</height>
                    <texture colordiffuse="FF1A1A1A">script.plex/white-rounded-ar16x9.png</texture>
                </control>
                <control type="image">
                    <posx>0</posx>
                    <posy>0</posy>
