...
<control type="group" id="50">
    ...
    <control type="group">
        ...
        <control type="group">
            ...
            <control type="image">
                ...
                <width>300</width>
                <height>{{ vscale(300) }}</height>
                <texture background="true" diffuse="script.plex/masks/role.png">$INFO[Window.Property(director.thumb)]</texture>
        ...
        <control type="group">
            ...
            <control type="label">
                ...
                <label>$INFO[Window.Property(director.name)]</label>
            </control>
            ...
            <control type="label">
                ...
                <label>$ADDON[script.plexmod 32474]</label>
            </control>

            <!-- Birth Date and Age -->
            <control type="group">
                <visible>!String.IsEmpty(Window.Property(director.birthDate))</visible>
                <posx>0</posx>
                <posy>{{ vscale(90) }}</posy>

                <control type="label">
                    <visible>!String.IsEmpty(Window.Property(director.age))</visible>
                    <posx>0</posx>
                    <posy>0</posy>
                    <width>1400</width>
                    <height>{{ vscale(30) }}</height>
                    ...
                    <label>Born $INFO[Window.Property(director.birthDate)] ($INFO[Window.Property(director.age)] years)</label>
                </control>
                <control type="label">
                    <visible>String.IsEmpty(Window.Property(director.age))</visible>
                    <posx>0</posx>
                    ...
                    <aligny>center</aligny>
                    <textcolor>AAFFFFFF</textcolor>
                    <label>Born $INFO[Window.Property(director.birthDate)]</label>
                </control>
            </control>
            ...
            <control type="textbox">
                ...
                <label>$INFO[Window.Property(director.summary)]</label>
            </control>
        </control>
    </control>
    ...
    <control type="group" id="500">
        ...
        <control type="label">
            ...
            <aligny>center</aligny>
            <textcolor>FFFFFFFF</textcolor>
            <label>[UPPERCASE]$ADDON[script.plexmod 32477][/UPPERCASE]</label>
        </control>
    ...
    <!-- Discover Hub Slots (Not in Library - Directed, etc.) -->
    {% for i in range(6) %}
